...
var Game = function () {
  ...
  createClass(Game, [{
    ...
    value: function initDOM() {
      ...
      config.gameContainer.appendChild(createElement('div', { className: 'heading' }, [createElement('div', { className: 'scores-container' }, [config.scoreContainer, config.bestContainer])]));
